  ...
  return (
    <section className="max-w-7xl mx-auto pt-40 px-8">
      <div className="flex items-end justify-between gap-6 mb-10">
        <div>
          <h2 className="text-4xl font-extrabold">Test ishlash</h2>
          <p className="text-gray-600 mt-2">
            Fan tanlang va testlarni boshlang.
          </p>
        </div>
      </div>
        ...
        {SUBJECTS.map((s, idx) => (
          ...
          >
            ...
            <div className="mt-8">
              ...
              >
                {s.enabled ? "Testlarni ko‘rish →" : "Yaqinda qo‘shiladi"}
              </span>
            </div>
          </motion.button>
        ))}
